    ...
    <div>
      ...
      <div>
        ...
        <ul className="list-[circle] ">
          ...
          <li>Address: Khatri Chowk, Bhuj, Kachchh, Gujarat, India</li>
        </ul>
        <p>
        ...
        <p>
          where we share behind-the-scenes moments of how each Bandhani piece
          comes alive.
        </p>
        <p>Let’s keep the art breathing together.</p>
      </div>
    </div>
  )
}
